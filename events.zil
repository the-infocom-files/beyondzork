...
<ROUTINE I-CRAB ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,CRAB>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-RAT ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,RAT>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-SNIPE ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,SNIPE>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-SPIDER ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,SPIDER>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-SLUG ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,SLUG>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-WORM ("AUX" L DIR DAMAGE)
	 <SET L <LOC ,WORM>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-PUPP ("AUX" L PL DIR DAMAGE)
	 <SET L <LOC ,PUPP>>
	 <COND (<EQUAL? .L ,HERE>
...
<ROUTINE I-DORN ("AUX" X L DIR DAMAGE)
	 <SET L <LOC ,DORN>>
	 <COND (<EQUAL? .L ,HERE>
		<MAKE ,DORN ,SEEN>
		<TELL ,TAB>
...
<ROUTINE I-MAMA ("AUX" TBL X L NL PL PLL DIR)
	 <SET L <LOC ,MAMA>>
	 <SET PL <LOC ,PLAYER>>
	 <COND (<VISIBLE? ,MAMA>
