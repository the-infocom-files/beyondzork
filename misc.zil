...
<ROUTINE CLOCKER ("AUX" (FLG 0) (Q? 0) E TICK RTN X)
	 <COND (<T? ,CLOCK-WAIT?>
	        <SETG CLOCK-WAIT? <>>
	        <RFALSE>)>
...
<ROUTINE THE-PRINT ("OPT" (O ,PRSO))
         <COND (<NOT <IS? .O ,NOARTICLE>>
		<TELL ,LTHE>)>
	 <DPRINT .O>
	 <RTRUE>>

<ROUTINE CTHE-PRINT ("OPT" (O ,PRSO))
...
<ROUTINE MONSTER-STRIKES? (OBJ "AUX" (DAMAGE 0) STR CHANCE)
	 <SEE-MONSTER .OBJ>
...
<ROUTINE MOVE-MONSTER? (OBJ "OPT" (UD 0)
			"AUX" L RLIST RLEN CNT DIR TBL DEST X FEAR)
	 <COND (<IS? .OBJ ,SLEEPING>
		<UNMAKE .OBJ ,SLEEPING>
		<UNMAKE .OBJ ,STRICKEN>
		<UNMAKE .OBJ ,NEUTRALIZED>
