...
<ROUTINE SHOW-MENU-ITEM (LINE "OPT" (INV 0))
	 <CENTER <+ .LINE 7> 35>
	 <COLOR ,GCOLOR ,BGND>
	 <HLIGHT ,H-NORMAL>
	 <COND (<T? .INV>
...
<ROUTINE MANUAL ("AUX" A OA X NX Y Z OP KEY TBL)
	 <SET A ,ENDURANCE>
	 <REPEAT ()
	    <PUT ,STATS .A 1>
...
<ROUTINE ROLL-YOUR-OWN ("AUX" STAT XSTAT DELTA STAT-ORDER X)
	 <SET STAT ,ENDURANCE>
	 <REPEAT ()
	    <PUT ,STATS .STAT 1>
